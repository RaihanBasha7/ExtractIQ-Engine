...
from app.config import GROQ_API_KEY, GROQ_MODEL, LLM_PROVIDER  # noqa: E402
...
from app.extraction import _get_client  # noqa: E402
...
print("   ✓ TicketExtraction created successfully")
